...
export const APP: ModuleItem[] = [
  ...
  { id: 'leads', label: 'Marketing & Lead Management', icon: 'leads', subs: [
    ...
    { id: 'capture', label: 'Lead Capture', spec: { dyn: 'captureChannels',
      sub: 'Connect Meta Lead Ads, Google Ads lead forms, your website form and a Google Sheet. Every channel feeds the same pipeline as the CSV import \u2014 same duplicate rules, same auto-assignment, and a repeated delivery never creates a second lead.' } },
