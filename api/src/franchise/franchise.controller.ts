...
export class FranchiseController {
  ...
  list() { return this.franchises.list(); }

  @Get('franchises/:id')
  @RequirePermission('franchise.read')
  get(@Param('id', ParseIntPipe) id: number) { return this.franchises.get(id); }

  @Get('franchises/:id/scope')
  @RequirePermission('franchise.read')
  scope(@Param('id', ParseIntPipe) id: number) { return this.franchises.scope(id); }

  @Get('franchises/:id/dashboard')
  @RequirePermission('franchise.read')
  dashboard(@Param('id', ParseIntPipe) id: number, @Query() q: Record<string, string | string[]>) {
  ...
  statement(@Param('id', ParseIntPipe) id: number, @Query() q: Record<string, string | string[]>) {
